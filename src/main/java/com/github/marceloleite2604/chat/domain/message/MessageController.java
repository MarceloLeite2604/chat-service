...
//  public Mono<ResponseEntity<Mono<Void>>> put(
//    @RequestBody
//    @Validated(Put.class)
...
//  public Mono<ResponseEntity<Mono<Void>>> post(
//    @PathVariable
//    @ValidUuid
//    String id,
//
...
//
//  @GetMapping(path = "/{id}")
//  public ResponseEntity<Mono<MessageDto>> get(@PathVariable @ValidUuid String id) {
//
//    final var uuid = UUID.fromString(id);
//
...
//
//  @GetMapping
//  public ResponseEntity<Flux<MessageDto>> getAll() {
//
...
//  public ResponseEntity<Mono<Void>> delete(@PathVariable @ValidUuid String id) {
//
//    final var uuid = UUID.fromString(id);
//
